...
public class SelectProblemCase2Test extends CreditApplicationTest {

    @Test
    public void 선택문제2() throws InterruptedException{

        //1. 결제 금액 20000원, 부가가치세 909 => success
        ...
        //4. 취소긍맥 10000, 부가가치세 909 => success
